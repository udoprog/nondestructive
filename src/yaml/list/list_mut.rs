...
impl<'a> ListMut<'a> {
    ...
    push_float!(push_f32, f32, "32-bit float", 10.42, FLOAT_32);
    push_float!(push_f64, f64, "64-bit float", 10.42, FLOAT_64);
    push_number!(push_u8, u8, "8-bit unsigned integer", 42, UNSIGNED_8);
    push_number!(push_i8, i8, "8-bit signed integer", -42, SIGNED_8);
    push_number!(push_u16, u16, "16-bit unsigned integer", 42, UNSIGNED_16);
    push_number!(push_i16, i16, "16-bit signed integer", -42, SIGNED_16);
    push_number!(push_u32, u32, "32-bit unsigned integer", 42, UNSIGNED_32);
    push_number!(push_i32, i32, "32-bit signed integer", -42, SIGNED_32);
    push_number!(push_u64, u64, "64-bit unsigned integer", 42, UNSIGNED_64);
    push_number!(push_i64, i64, "64-bit signed integer", -42, SIGNED_64);
    push_number!(push_u128, u128, "128-bit unsigned integer", 42, UNSIGNED_128);
    push_number!(push_i128, i128, "128-bit signed integer", -42, SIGNED_128);
}

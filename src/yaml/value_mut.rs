...
impl<'a> ValueMut<'a> {
    ...
    set_float!(set_f32, f32, "32-bit float", 10.42, Float32);
    set_float!(set_f64, f64, "64-bit float", 10.42, Float64);
    set_number!(set_u8, u8, "8-bit unsigned integer", 42, Unsigned8);
    set_number!(set_i8, i8, "8-bit signed integer", -42, Signed8);
    set_number!(set_u16, u16, "16-bit unsigned integer", 42, Unsigned16);
    set_number!(set_i16, i16, "16-bit signed integer", -42, Signed16);
    set_number!(set_u32, u32, "32-bit unsigned integer", 42, Unsigned32);
    set_number!(set_i32, i32, "32-bit signed integer", -42, Signed32);
    set_number!(set_u64, u64, "64-bit unsigned integer", 42, Unsigned64);
    set_number!(set_i64, i64, "64-bit signed integer", -42, Signed64);
    set_number!(set_u128, u128, "128-bit unsigned integer", 42, Unsigned128);
    set_number!(set_i128, i128, "128-bit signed integer", -42, Signed128);
}

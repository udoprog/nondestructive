...
impl<'a> TableMut<'a> {
    ...
    insert_float!(insert_f32, f32, "32-bit float", 10.42, FLOAT_32);
    insert_float!(insert_f64, f64, "64-bit float", 10.42, FLOAT_64);
    insert_number!(insert_u8, u8, "8-bit unsigned integer", 42, UNSIGNED_8);
    insert_number!(insert_i8, i8, "8-bit signed integer", -42, SIGNED_8);
    insert_number!(insert_u16, u16, "16-bit unsigned integer", 42, UNSIGNED_16);
    insert_number!(insert_i16, i16, "16-bit signed integer", -42, SIGNED_16);
    insert_number!(insert_u32, u32, "32-bit unsigned integer", 42, UNSIGNED_32);
    insert_number!(insert_i32, i32, "32-bit signed integer", -42, SIGNED_32);
    insert_number!(insert_u64, u64, "64-bit unsigned integer", 42, UNSIGNED_64);
    insert_number!(insert_i64, i64, "64-bit signed integer", -42, SIGNED_64);
    insert_number!(
        insert_u128,
        u128,
    ...
    insert_number!(insert_i128, i128, "128-bit signed integer", -42, SIGNED_128);
}
